...
- **Hintergrund**: what fills a screen behind everything else — one of 4 presets, a free RGB colour, or "ohne" for an unlit screen. Changing it recolours *behind* whatever foreground the screen has, rather than replacing it.
